 ...
 const ContactsItem = ({contact}) => {
    ...
    return (
        <div className="card">
              ...
              <div className="card-link"><button className="btn btn-danger btn-sm">Delete</button> </div>
              <div className="card-link"><button className="btn btn-primary btn-sm">Update</button> </div>
              </div>
        </div>
    )
}
